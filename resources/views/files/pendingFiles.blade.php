...
@section('title')
{{ __('messages.pending files') }}
@endsection
<!-- start:breadcrumb -->
@section('breadcrumb')
<li class="breadcrumb-item active" aria-current="page">{{ __('messages.files') }}</li>
<li class="breadcrumb-item active" aria-current="page">{{ __('messages.pending files') }}</li>
            ...
            <div class="card-body">
                <div>
                    <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add-group"
                        title="add group"><i class="fa fa-success fa-plus">Upload
                            file</i>
                    </button>
                    <br>
                </div>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <form id="multiCheckInForm" action="{{ route('admin.dashboard.files.multiApprove')}}"
                                    method="POST">
                                    @csrf
